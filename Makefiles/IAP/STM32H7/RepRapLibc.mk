...
RRFLIBC_OBJ_SRC_CXX += $(RRF_SRC_BASE)/Hardware/TGBTC/Libraries/Fatfs/SDCardSDIO.cpp $(RRF_SRC_BASE)/Hardware/TGBTC/Libraries/Fatfs/SDCardSPI.cpp $(RRF_SRC_BASE)/Hardware/TGBTC/Libraries/Fatfs/sd_mmc_wrapper.cpp
endif
endif

RRFLIBC_INCLUDES = $(addprefix -I, $(RRFLIBC_SRC))
ifeq ($(CONFIG),IAP_BOOT_LOADER)
RRFLIBC_INCLUDES += -I$(RRF_SRC_BASE)/Hardware/TGBTC/Libraries/Fatfs/
